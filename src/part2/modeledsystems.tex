...
I have not been successful in finding values for the shear viscosity and diffusivity of bulk liquid water modeled with TIP4P. To measure these properties, I run a simulation like the one I ran to calculate the same properties for the TIP4P/2005 potential. Figure @ref shows the auto-correlation function of the non-diagonal pressure components. The shear viscosity is estimated to @value. 
