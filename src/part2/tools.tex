...
It is cumbersome to calculate stiffness paramenters using molecular dynamics. Therefore I use a dedicated program -- General Utility Lattice Program (GULP) -- to caculate these parameters.

\section{Crack tracer}
I have implemented my own crack tracer based on the idea from \cite{Hantal2014}.