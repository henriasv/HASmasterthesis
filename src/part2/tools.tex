...
\begin{enumerate}
\item \tb{Initialization:} Define the units (e.g. SI or {\tt real}) of the simulation. Describe the simulation box. Define the interactions that will go into the simulation. 
