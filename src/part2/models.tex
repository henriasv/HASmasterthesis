...
\end{tikzpicture}
\caption{Illustration of the model system. The blue area is initially a pure sI methane hydrate crystal, and the area inside the red dashed ellipse an empty crack.}
