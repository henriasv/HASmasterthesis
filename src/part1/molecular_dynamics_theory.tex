...
The expectation value inside the integral assumes that a large number of systems are investigated. In practice, we apply the ergodic hypothesis and do a time average of a single simulation instead of an ensemble average. 
