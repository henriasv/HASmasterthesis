...
\fill[blue!40!white!, name intersections={of=stability and geoterm}]
	(intersection-1) .. controls (2.8, 4.2) and (3.565, 3.6) .. (intersection-2) -- (2, 3.0) -- (intersection-1);
...
\end{tikzpicture}
\caption{Methane hydrate stability zone in permafrost.}
...
\fill[blue!40!white!, name intersections={of=stability and watertemp}]
	(intersection-1) to [out=-15, in=96] (intersection-2) -- (2, 3.0) to [out=85, in=250] (intersection-1);
...
\end{tikzpicture}
\caption{Methane hydrate stability conditions to the left of the phase boundary.  The zone between the horizontal dashed lines is the hydrate stability zone.}
