...
\end{tikzpicture}
\caption{Gas hydrate stability conditions to the left of the (black) phase boundary. The red line shows the tempterature as a function of depth. In permafrost, the temperature is always increasing with increasing depth. This leaves a limited depth zone where the temperature–pressure configuration is to the left of the phase boundary. This is the gas hydrate stability zone (GHSZ).}
...
\end{tikzpicture}
\caption{Gas hydrate stability conditions to the left of the (black) phase boundary. The red line shows the tempterature as a function of depth. In seawater, the temperature falls all the way down to the sea floor, then the temperature follows the geoethermal gradient, which means it increases with depth. This leaves a limited depth zone where the temperature–pressure configuration is to the left of the phase boundary. This is the gas hydrate stability zone (GHSZ). Note that the pressure gradient is smaller in seawater than in permafrost, so the GHSZ starts deeper.}
...
@WeAreInterestedInMechanicalPropertiesBecause
